...
typedef enum simbolos {
  ...
  simb_integer, simb_array, simb_of, simb_procedure,
  simb_function, simb_if, simb_then, simb_else,
  simb_goto, simb_while, simb_numero, simb_igual,
...
void geraCodigoREAD(tab_simbolos* ts, pilha_ident* pi);
void geraCodigoWRITE(tab_simbolos* ts, pilha_ident* pi);
int yylex();
