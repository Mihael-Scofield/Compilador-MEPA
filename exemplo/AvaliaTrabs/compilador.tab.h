...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    MENOR_IGUAL_QUE = 291,         /* MENOR_IGUAL_QUE  */
    MAIOR_IGUAL_QUE = 292,         /* MAIOR_IGUAL_QUE  */
    MENOR_QUE = 293,               /* MENOR_QUE  */
    MAIOR_QUE = 294,               /* MAIOR_QUE  */
    READ = 295,                    /* READ  */
    WRITE = 296,                   /* WRITE  */
    NOT = 297,                     /* NOT  */
    BOLLEANO = 298,                /* BOLLEANO  */
    T_TRUE = 299,                  /* T_TRUE  */
    T_FALSE = 300,                 /* T_FALSE  */
    DO = 301,                      /* DO  */
    DIVIDEB = 302,                 /* DIVIDEB  */
    DOIS_PONTOS_SEQ = 303,         /* DOIS_PONTOS_SEQ  */
